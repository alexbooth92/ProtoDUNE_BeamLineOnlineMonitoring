...
export CLASSPATH=$DIPBASE/lib64/dip-jni-5.6.3.nar:$DIPBASE/lib64/dip-jni-5.6.3-.nar:.:$CLASSPATH
export LD_LIBRARY_PATH=$DIPBASE/lib64:$LD_LIBRARY_PATH
echo
echo CLASSPATH was extended with $DIPBASE/lib64/dip-jni-5.6.3.nar:.
echo
